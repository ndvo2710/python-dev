...
[示例5](./Chapter-06-code/css-example5.html)
````
# css
...
[示例6](./Chapter-06-code/css-example6.html)
```
.task {
  background: maroon;
}
...
[示例7](./Chapter-06-code/css-example7.html)
```
.task {
  background: #800000;
}
...
[示例8](./Chapter-06-code/css-example8.html)
````
.task {
...
[示例9](./Chapter-06-code/css-example9.html)
```
.task {
